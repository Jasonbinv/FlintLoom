...
`doc_generate` 见 [生成设计](2026-08-17-flintloom-docforge-generate-design.md)。`doc_convert` 见 [转换设计](2026-08-18-flintloom-docforge-convert-design.md)。`doc_edit` 见 [编辑设计](2026-08-18-flintloom-docforge-edit-design.md)。`doc_compare` 见 [对比设计](2026-08-19-flintloom-docforge-compare-design.md)。summarize 仍待拆。  
