...
`doc_edit` 见 [编辑设计](2026-08-18-flintloom-docforge-edit-design.md)。`doc_compare` 见 [对比设计](2026-08-19-flintloom-docforge-compare-design.md)。summarize、通道、`flint plugin add` 不在本片。
